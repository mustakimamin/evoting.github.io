...
class Calon extends CI_Controller {
    ...
    public function proses_tambah(){
        ...
        if ($this->upload->do_upload('foto_calon'))
        {
            ...
            $data = [
                'kelas_calon_ketua_osis'=>$this->input->post('kelas_calon_ketua_osis',true),
                'kelas_calon_wakil_osis'=>$this->input->post('kelas_calon_wakil_osis',true),
                'nis_calon_ketua_osis'=>$this->input->post('nis_calon_ketua_osis',true),
                'nis_calon_wakil_osis'=>$this->input->post('nis_calon_wakil_osis',true),
                'calon_ketua_osis'=>$this->input->post('calon_ketua_osis',true),
                'calon_wakil_osis'=>$this->input->post('calon_wakil_osis',true),
