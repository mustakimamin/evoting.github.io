...
<head>
    ...
    <!-- chart.js -->
    <link href="<?=base_url('assets/');?>js/chart.min.js" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color:#7109e0;">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                <div class="sidebar-brand-text mx-3">E-Voting<sup></sup></div>
            </a>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item <?=isset($mDashboard)?'active':'';?>" data-tilt>
            ...
            <!-- Nav Item - Fakultas -->
            <li class="nav-item <?=isset($mFakultas)?'active':'';?>" data-tilt>
                <a class="nav-link" href="<?=base_url('fakultas');?>">
                    <i class="fas fa-fw fa-user"></i>
                    <span>Kelas</span></a>
            </li>
            <!-- Nav Item - Operator -->
            <li class="nav-item <?=isset($mOperator)?'active':'';?>" data-tilt>
            ...
            <li class="nav-item <?=isset($mPemilih)?'active':'';?>" data-tilt>
            ...
            <?php if($this->session->userdata('level')=='administrator'): ?>
            <!-- Nav Item - Data Calon -->
            <li class="nav-item <?=isset($mCalon)?'active':'';?>" data-tilt>
                <a class="nav-link" href="<?=base_url('calon');?>">
                    <i class="fas fa-fw fa-user-plus"></i>
                    <span>Data Calon</span></a>
            </li>
            <?php endif; ?>
            <?php if($this->session->userdata('level')=='user' || $this->session->userdata('level')=='operator'): ?>
            <!-- Nav Item - Pemilihan Suara -->
            <li class="nav-item <?=isset($mPemilihan)?'active':'';?>" data-tilt>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span
                                    class="mr-4 d-none d-lg-inline text-white text-uppercase"><?= $this->session->nama; ?></span>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; e-Voting <?= date('Y'); ?> | Repost by <a>SMP Pancakrida Kalirejo</a>
                        </span>
                    </div>
                </div>
            </footer>
