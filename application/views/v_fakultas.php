    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php $n=1;foreach($kelas as $f): ?>
                    <tr>
                        <td><?= $n++; ?></td>
                        <td><?= strtoupper($f['nama_kelas']); ?></td>
                        <td>
                            <a href="<?=base_url('fakultas/hapus/');?><?=$f['id_kelas'];?>"
            ...
            <form action="<?=base_url('fakultas/tambah');?>" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control uppercase" id="fakultas" name="nama_kelas" required>
                    </div>
                </div>
