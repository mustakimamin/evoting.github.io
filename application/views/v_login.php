            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5" >
                    <div class="card-body p-0">
                        <h2 class="p-4 text-gray-900 border-bottom-primary text-center">Aplikasi Evoting Pemilihan Ketua OSIS</h2>
                        <!-- Nested Row within Card Body -->
                        <div class="row ">
                            <div class="col-lg-5 d-done d-lg-block text-center mt-1 pl-5" data-tilt>
                                <img src="<?=base_url('assets/');?>/img/Logo OSIS SMP.jpg" height="350">
                            </div>
                                    ...
                                    <form class="user" action="<?=base_url('login/cek_login');?>" method="post" >
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                placeholder="Username/NIS" name="nama" autofocus required>
                                        </div>
                                        <div class="form-group">
