...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <?php if($config['status']=='aktif' && $this->session->userdata('level')=='administrator'): ?>
...
<?php endif; ?>
<?php if($this->session->userdata('level')=='administrator' || $this->session->userdata('level')=='operator' || $this->session->userdata('level')=='user'):?>
<!-- Content Row -->
<div class="row">

    <!-- Total Pasangan Calon -->
    <div class="col-xl-3 col-md-6 mb-4" data-tilt>
    ...
    <div class="col-lg-12 mb-4">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary float-left">Grafik Perolehan Suara</h6>
    ...
    <div class="col-lg-12 mb-4">
        ...
        <div class="card shadow mb-4">
            <div>
                ...
                <script>
                    const labels = [
                      'Muhammad Neval Maldi & Dwi Putri Januari ',
                      'Armelia nur asyiffa & Ahmad Fauzan Naufal',
                    ];
                    const data = {
                      labels: labels,
                      datasets: [{
                        label: 'Grafik Perolehan Suara',
