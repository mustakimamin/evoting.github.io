        ...
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?= $n++; ?></td>
                        <td><a href="<?=base_url('calon/detail/'.$c['id_calon']);?>"><?= $c['calon_ketua_osis']; ?></a></td>
                        <td><a
                                href="<?=base_url('calon/detail/'.$c['id_calon']);?>"><?= $c['calon_wakil_osis']; ?></a>
                        </td>
                        <td><?= $c['visi_misi']; ?></td>
                        <td>
