...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Tambah Data Calon Ketua dan Wakil Ketua OSIS</h1>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="kelas_calon_ketua_osis">
                                    ...
                                    <option value="<?= $f['nama_kelas']; ?>"><?= ucwords($f['nama_kelas']); ?>
                                    </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="presma" name="nis_calon_ketua_osis" autofocus
                                    required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="presma" name="calon_ketua_osis" autofocus required>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="presma" name="nis_calon_wakil_osis" autofocus
                                    required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="wapresma" name="calon_wakil_osis" required>
                    </div>
                </div>
                <div class="col-md-6">
