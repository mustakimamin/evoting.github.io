...
INSERT INTO `tb_admin` (`id_admin`, `username`, `password`, `id_kelas`, `level`) VALUES
...
CREATE TABLE `tb_calon` (
  ...
  `kelas_calon_presma` varchar(128) NOT NULL,
  `kelas_calon_wapresma` varchar(128) NOT NULL,
  `nis_calon_presma` varchar(10) NOT NULL,
  `nis_calon_wapresma` varchar(10) NOT NULL,
...
INSERT INTO `tb_calon` (`id_calon`, `kelas_calon_presma`, `kelas_calon_wapresma`, `nis_calon_presma`, `nis_calon_wapresma`, `calon_presma`, `calon_wakil_presma`, `visi_misi`, `gambar`, `video`) VALUES
...
INSERT INTO `tb_pemilih` (`id_pemilih`, `id_kelas`, `nim`, `nama`, `email`, `password`) VALUES
